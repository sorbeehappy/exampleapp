                        ...
                        <li>
                            <router-link to="/store" class="waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                               <i class="mdi mdi-cart-outline"></i>
                                <span class="hide-menu"><strong>ຮ້ານຄ້າ</strong> 
                                </span>
                            </router-link>                            
                        </li>
                        <li>
                            <router-link to="/pos" class="waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                               <i class="mdi mdi-cart-plus"></i>
                                <span class="hide-menu">ໜ້າຮ້ານ
                                </span>
                            </router-link>                            
                        </li>
                        <li>
                            <router-link to="/transaction" class="waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="mdi mdi-book-multiple"></i>
                                <span class="hide-menu">ລາຍການເຄື່ອນໄຫວ
                                </span>
                            </router-link>                            
                        </li>
                        <li>
                          ...
                          <li>
                            <router-link to="/register" class="waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="mdi mdi-account-plus"></i>
                                <span class="hide-menu">ລົງທະບຽນ
                                </span>
                            </router-link>                            
                        </li>
                    </ul>
